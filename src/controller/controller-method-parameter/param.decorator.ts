...
export const Param = (name: string, pipes?: Array<ConstructorFunction<PipeInterface>>): ParameterDecorator => {
  return function (target: Object, propertyKey: string | symbol | undefined, parameterIndex: number) {
    if (propertyKey !== undefined) {
      const existingParamParameters: RoutableMethodParameterMetadataType =
      ...
      existingParamParameters.push({
        index: parameterIndex,
        value: { paramName: name },
        type: RoutableMethodParameterTypeEnum.PARAM,
      });
